...
<template>
  <div id="parentx-demo-2">
    ...
    >
      <div slot="header" class="header-sidebar relative flex flex-col p-0">
        <feather-icon
          icon="XIcon"
      ...
      >
        <div class="p-8">
          <h6 :class="{ 'ml-4': isLoggedInUser }" class="mb-2">About</h6>
          <vs-textarea
            v-if="isLoggedInUser"
          ...
          <div v-if="isLoggedInUser" class="userProfile__status">
